...
Namespace BizzLib
    Public Class frmDialogNewAnalyze
        Inherits frmBKForm
        ' Methods
        Public Sub New()
            ...
            Dim list As ArrayList = frmDialogNewAnalyze.__ENCList
            SyncLock list
                frmDialogNewAnalyze.__ENCList.Add(New WeakReference(Me))
            End SyncLock
        ...
        Private Sub InitializeComponent()
            ...
            Dim manager As New ResourceManager(GetType(frmDialogNewAnalyze))
            ...
            Me.Name = "frmDialogNewAnalyze"
            Me.HelpProvider1.SetShowHelp(Me, True)
            Me.ShowInTaskbar = False
            Me.Text = "Please type a Name, Descrip for the New Analyze"
        ...
        ' Properties
        Public Property AnalyzeDesc As String
            Get
        ...
        Public Property AnalyzeName As String
            Get
