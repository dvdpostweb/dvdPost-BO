...
Namespace BizzLib
    Public Class frmDialogueSelectExcelFile
        Inherits frmBKForm
        ' Methods
        Public Sub New()
            ...
            Dim list As ArrayList = frmDialogueSelectExcelFile.__ENCList
            SyncLock list
                frmDialogueSelectExcelFile.__ENCList.Add(New WeakReference(Me))
            End SyncLock
        ...
        Private Sub InitializeComponent()
            ...
            Dim manager As New ResourceManager(GetType(frmDialogueSelectExcelFile))
            ...
            Me.SaveFileDialog1.Filter = "Excel Files|*.xls|All files|*.*"
            ...
            Me.Name = "frmDialogueSelectExcelFile"
