Public Class frmProducts_Browse
...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        _SQLTxt = " SELECT  P.products_id, P.products_type, P.products_quantity, P.products_model , P.imdb_id, P.products_title, P.products_price, " & _
                  " P.products_date_added, P.products_date_available, P.products_status, P.products_year, P.products_sale_price, P.products_sale_date, " & _
                  " P.quantity_to_sale,  " & _
                  "        PDesc_FR.products_name as FR_Title, " & _
                  "        PDesc_NL.products_name as NL_Title, " & _
                  "        PDesc_EN.products_name as EN_Title, d.directors_name as director " & _
                  " FROM   products P " & _
                  " LEFT JOIN products_description PDesc_FR ON P.products_id = PDesc_FR.products_id and PDesc_FR.language_id = 1 " & _
                  " LEFT JOIN products_description PDesc_NL ON P.products_id = PDesc_NL.products_id and PDesc_NL.language_id = 2 " & _
                  " LEFT JOIN products_description PDesc_EN ON P.products_id = PDesc_EN.products_id and PDesc_EN.language_id = 3 " & _
