...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'btnPrintSelected
        '
        Me.btnPrintSelected.Location = New System.Drawing.Point(880, 40)
        ...
        Me.GridControl2.Size = New System.Drawing.Size(522, 286)
...
#End Region
    ...
    Private Sub SaveTheBox()
        ...
        If Not chkADD.Checked Then
            ...
            _i = BKGlobal.Cls1.ExecuteNonQuery("")
            DoEvents()
            _StartPosition = 0
        Else
        ...
        For Each _row In objDS.Tables("products_dvd_stock_2").Rows
            ...
            _objProduct = New clsProduct_DVD(SessionInfo, _DS, _row.Item("products_id"), _row.Item("products_dvdid"))
            _objProduct.SetProductsStatusBox(1, _row.Item("box_id"), _StartPosition + _row.Item("pibox_id"))
            'Mike 10-12-07            _objProduct.ChangeProductsQuantity(1)
        Next
        txtProducts_id.Text = ""
        DoEvents()
        RefreshLists()
