...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        SQLTxt1 = "SELECT C.customers_id , customers_gender, customers_firstname ,customers_lastname , customers_email_address , " & _
                  ...
                  " customers_abo_dvd_home_norm, customers_abo_dvd_home_adult , ac.activation_group, ac.activation_code_creation_date " & _
          " , customers_next_abo_type, count(mail_messages_id) as already_sent,  C.selected_for_email, " & _
          ...
          " LEFT JOIN mail_messages_sent_history mh on mh.customers_id = C.customers_id and mail_messages_id = " & intmessages_id & " "
