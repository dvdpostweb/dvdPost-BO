...
#End Region
    ...
    Private Sub This_frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        SQLTxtCustomers = "SELECT customers_id , customers_firstname ,customers_lastname , customers_email_address , customers_language, discount_code" & _
          " FROM customers_nl_temp"
    ...
    Public Sub LoadCustomerList()
        ...
        Catch eFillDataSet As System.Exception
            Throw eFillDataSet
        End Try
        ViewCustToSend = New DataView(objDS.Tables(TableName))
    ...
    Private Sub SendMails()
        'Sending E-Mails
        Dim strFrom As String = "dvdpost@dvdpost.nl"
        Dim strTo As String
        ...
        For Each _custrow In ViewCustToSend '_i = 0 To GridView1.RowCount - 1
            ...
            If ViewMessage.Count = 1 Then
                ...
                'customers_Code
                strMessage = Replace(strMessage, "$$$customers_code$$$", _custrow.Item("discount_code"))
