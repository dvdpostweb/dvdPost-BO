...
Public Class frmNoAboWithDVDAtHomeEMail
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmNoAboWithDVDAtHomeEMail))
        ...
        Me.Name = "frmNoAboWithDVDAtHomeEMail"
...
#End Region
    ...
    Dim intmessages_id As Integer = 104 'NO ABo with DVD at home - Please send back
    ...
    Private Sub This_frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'SQLTxtCustomers = "SELECT c.customers_info_date_account_created,c.customers_id , customers_gender, customers_firstname ,customers_lastname , customers_email_address , " & _
        ...
        '  " if (customers_dob = '0000-00-00', Null, customers_dob) as customers_dob , customers_language " & _
        '  " FROM customers c " & _
        '  " WHERE  c.customers_abo = 0   and ( customers_abo_dvd_home_adult + customers_abo_dvd_home_norm) <> 0  GROUP BY c.customers_id"

        ''Select All Cust ---- Remove Customers_ID criteria and C.customers_id = 115503
        ''" WHERE c.customers_id = 115503"
    ...
    Private Sub btnLoadInfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLoadInfo.Click
        ...
        'DvdPostData.clsConnection.FillDataSet(objDS.Tables("prod_instock_image_view1"), SQLTxtProducts)
        'Load Categories of products
        'objDS.Tables("products_to_categories").Clear()
        'DvdPostData.clsConnection.FillDataSet(objDS.Tables("products_to_categories"), SQLTxtProductsToCategories)
        'Dim _i As Integer = 1
        ...
        '    _View = New DataView(objDS.Tables("products_to_categories"), "products_id = " & _row("products_id"), "", DataViewRowState.CurrentRows)
        '    For Each _rowview In _View
        '        _row("categories") = _row("categories") & _rowview("categories_id") & "-"
        '    Next
        '    _i += 1
        '    DoEvents()
        'Next
    ...
    Private Sub loadDataset()
        ...
        sql = " select pd.products_name Products_titles, c.*,pd.*,p.* " & _
        " from orders o " & _
        ...
        " where(o.orders_status = " & DvdPostData.clsOdersStatusHistory.orderStatus.ORDERS_STATUS_EXPEDITED & " And c.customers_abo = " & DvdPostData.ClsCustomersData.abo.UNVALID & ") "
    ...
    Private Sub btnStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStart.Click
        ...
        For Each row As DataRow In _dt.Rows
            DVDPostBuziness.clsMail.SendMail(row, DVDPostBuziness.clsMail.Mail.MAIL_DVDHOME)
        Next
    ...
    Public Sub LoadCustomerList()
        ...
        '    Throw eFillDataSet
        'End Try
        'ViewCustToSend = New DataView(objDS.Tables(TableName), "", "customers_id", DataViewRowState.CurrentRows)
        ...
        loadDataset()
        txtTotalCustomers.EditValue = _dt.Rows.Count
    End Sub
