...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridControl1.Size = New System.Drawing.Size(512, 254)
        ...
        'btnPrintSelected
        '
        Me.btnPrintSelected.Location = New System.Drawing.Point(792, 40)
        Me.btnPrintSelected.Name = "btnPrintSelected"
        Me.btnPrintSelected.Size = New System.Drawing.Size(80, 23)
        Me.btnPrintSelected.TabIndex = 32
        Me.btnPrintSelected.Text = "Print Selected "
        '
        'btnPrintLabels
        '
        Me.btnPrintLabels.Location = New System.Drawing.Point(704, 40)
        ...
        'btnUpdate
        '
        Me.btnUpdate.Location = New System.Drawing.Point(704, 16)
        ...
        'SplitterControl1
        '
        Me.SplitterControl1.Location = New System.Drawing.Point(512, 104)
        Me.SplitterControl1.Name = "SplitterControl1"
        Me.SplitterControl1.Size = New System.Drawing.Size(6, 254)
        ...
        Me.GridControl2.Location = New System.Drawing.Point(518, 104)
        ...
        Me.GridControl2.Size = New System.Drawing.Size(522, 254)
        ...
        Me.ClientSize = New System.Drawing.Size(1040, 358)
...
#End Region
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Pos_ID = 1
        BKGlobal.Cls1.FillDataSet(objDS.Tables("products_dvd_stock_1"), _SQLTxt)
        _SQLTxt = "SELECT PD.products_id, PD.products_dvdid, PD.products_dvd_status, PD.box_id, PD.pibox_id, P.products_model as products_model FROM products_dvd PD " & _
                                        " Left join products P on P.products_id = PD.products_id " & _
                                        " where PD.box_id = -1 "
        BKGlobal.Cls1.FillDataSet(objDS.Tables("products_dvd_stock_2"), _SQLTxt)
    ...
    Public Sub BarCode_OK()
        ...
        If txtBarCode.Text.Length = 13 Then
            ...
            _view = New DataView(objDS.Tables("products_dvd_stock_2"), "products_id = " & CInt(Product_ID) & " aND products_dvdid = " & CInt(DVD_ID), "", DataViewRowState.CurrentRows)
            ...
            _NewRow.Item("box_id") = txtBoxID.EditValue
            _NewRow.Item("pibox_id") = Pos_ID
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        For Each _row In objDS.Tables("products_dvd_stock_1").Rows
            _SQLTxt = "update products_dvd SET products_dvd_status = 15, last_adminby = " & _
                      SessionInfo.UserID & " , last_admindate = '" & Now & "', box_id = 0 , pibox_id = 0 " & _
                      " WHERE products_id = " & _row.Item("products_id") & _
                      " AND products_dvdid = " & _row.Item("products_dvdid")
            BKGlobal.Cls1.ExecuteNonQuery(_SQLTxt)
            '_row.BeginEdit()
            '_row.Item("box_id") = 0
            '_row.Item("pibox_id") = 0
            '_row.Item("inout") = 0
            '_row.Item("last_adminby") = SessionInfo.UserID
            '_row.Item("last_admindate") = Now()
            '_row.EndEdit()
        Next
        BKGlobal.Cls1.UpdateDataSource(objDS.Tables("products_dvd_stock_1"), "SELECT * FROM products_dvd")
        For Each _row In objDS.Tables("products_dvd_stock_2").Rows
            _SQLTxt = "update products_dvd SET products_dvd_status = 1, last_adminby = " & _
                      SessionInfo.UserID & " , last_admindate = '" & Now & "', box_id = " & _row.Item("box_id") & _
                      ", pibox_id = " & _row.Item("pibox_id") & _
                      " WHERE products_id = " & _row.Item("products_id") & _
                      " AND products_dvdid = " & _row.Item("products_dvdid")
            BKGlobal.Cls1.ExecuteNonQuery(_SQLTxt)
            '_row.BeginEdit()
            '_row.Item("inout") = 1
            '_row.Item("products_dvd_status") = 1
            '_row.Item("last_adminby") = SessionInfo.UserID
            '_row.Item("last_admindate") = Now()
            '_row.EndEdit()
        Next
        'BKGlobal.Cls1.UpdateDataSource(objDS.Tables("products_dvd_stock_2"), "SELECT * FROM products_dvd")
    End Sub
