...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDVDStatusHist_Browse))
...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        _SQLTxt = "select pshist.* , su.fullname as user_fullname , ps1.products_dvd_status_name as status_name, ps2.products_dvd_status_name as previous_status_name " & _
            " from (select pdsh.* from products_dvd_status_history pdsh join " & _
            "           (select products_id,products_dvdid,max(status_history_id) status_history_id " & _
            "            from products_dvd_status_history group by products_id,products_dvdid ) xx on pdsh.status_history_id = xx.status_history_id) pshist " & _
            ...
            " where status_date >= '" & _DateFromTxt & "'"
