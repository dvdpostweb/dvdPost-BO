...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        _SQLTxt = _
            ...
            " dc.discount_code, dc.discount_text_en as discount_cmt1, dc.comment as discount_cmt2 , ag.activation_group_name , ac.campaign,c.customers_info_date_account_created " & _
