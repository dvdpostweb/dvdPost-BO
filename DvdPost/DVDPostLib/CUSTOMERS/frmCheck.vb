Public Class frmCheck
    ...
    Public Sub New()
        ...
        btnUser1.Caption = "status order : retardé au retour"
    ...
    Private Sub loadDataset()
        Dim dt As DataTable
        dt = DVDPostBuziness.clsOrders.getOrderTwoWeekCheck()
    ...
    Private Sub btnUser1_Click(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles _user1.ItemClick
        ...
        DVDPostBuziness.clsOrders.UpdateOrder(orders_id, DvdPostData.clsOdersStatusHistory.OrderStatusNew.DELAYED_BACK, status)
        loadDataset()
        MsgBox("terminé")
    End Sub
