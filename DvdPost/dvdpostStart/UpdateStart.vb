Module UpdateStart
    ...
    Sub Main()
        ...
        If Not CopyFilesDirectory(strpath) Then
            If MsgBox("votre version n'est pas à jour ! cela peut engendrer des soucis, Voulez quand meme executer le programme ? ", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
