...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupControl2.Size = New System.Drawing.Size(408, 216)
        ...
        Me.GroupControl1.Location = New System.Drawing.Point(440, 16)
...
#End Region
    ...
    Private Sub LineUp(ByVal v_products_id As Integer, ByVal v_dvd_id As Integer)
        ...
        If intbox_id > 0 Then
            ...
            Else
                sSQL = "update products_dvd_adult pd set box_id = 0,  inout = 0,  pibox_id= 0 , last_adminby = '" & SessionInfo.UserID & "', last_admindate = now() where pd.products_id=" & v_products_id & " and pd.products_dvdid=" & v_dvd_id & " "
            End If
            ...
            Else
                sSQL = "update products_dvd_adult set pibox_id = pibox_id - 1 where box_id = '" & intbox_id & "' and pibox_id > '" & intpibox_id & "' order by pibox_id asc "
            End If
            BKGlobal.Cls1.ExecuteNonQuery(sSQL)
        End If
    End Sub
    Private Sub LineIn(ByVal v_products_id As Integer, ByVal v_dvd_id As Integer, ByVal v_BoxID As Integer, ByVal v_PiBoxID As Integer) 'Insert DVD In Stock
        ...
        If intbox_id >= 0 Then
            ...
            Else
                sSQL = "update products_dvd_adult set pibox_id = pibox_id + 1 where box_id = '" & v_BoxID & "' and pibox_id > '" & v_PiBoxID & "' order by pibox_id asc "
            End If
            BKGlobal.Cls1.ExecuteNonQuery(sSQL)
            ...
            Else
                sSQL = "update products_dvd_adult pd set box_id = " & v_BoxID & ",  inout = 0,  pibox_id = " & v_PiBoxID & " , last_adminby = '" & SessionInfo.UserID & "', last_admindate = now() where pd.products_id=" & v_products_id & " and pd.products_dvdid=" & v_dvd_id & " "
            End If
            BKGlobal.Cls1.ExecuteNonQuery(sSQL)
        End If
    End Sub
    ...
    Private Sub ChangeDVDStatus(ByVal v_products_id As Integer, ByVal v_dvd_id As Integer, ByVal v_newstatus As Integer)
        ...
        If v_newstatus > 1 Then
            ...
            Else
                sSQL = "update products_adult set products_quantity= products_quantity - 1 where products_id = '" & v_products_id & "' "
            End If
            BKGlobal.Cls1.ExecuteNonQuery(sSQL)
        ...
        Else
            sSQL = "update products_dvd_adult set products_dvd_status= '" & v_newstatus & "' where products_id = '" & v_products_id & "' and products_dvdid  = '" & v_dvd_id & "'"
        End If
        BKGlobal.Cls1.ExecuteNonQuery(sSQL)
        ...
        If v_newstatus = 16 Then ' given back to stucio
