...
#End Region
    ...
    Private Sub loadBankTRansfert()
        ...
        Else
            ...
            sql = DvdPostData.clsBatchBankTransfert.GetDataPaymentCustomerDetail(Me.DeditStart.DateTime, DeditEnd.DateTime, DvdPostData.clsBatchBankTransfert.LIMIT_DAYPAID, PaymentOfflineData.GetListRecovery, False)
    ...
    Private Sub _reconduction()
        ...
        'msg = displayInfo(ok, ClsCustomersData.Payment_Method.VIREMENT, ClsCustomersData.Country.BELGIQUE)
        ...
        msg = displayInfo(ok, DvdPostData.ClsCustomersData.Payment_Method.VIREMENT, DvdPostData.ClsCustomersData.Country.BELGIUM)
        ...
        msg = msg + displayInfo(ok, DvdPostData.ClsCustomersData.Payment_Method.VIREMENT, DvdPostData.ClsCustomersData.Country.NEDERLANDS)
