...
Partial Public Class dsABOProcess
    ...
    Partial Public Class wishlistDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
        Public Overloads Function AddwishlistRow(ByVal customers_id As Integer, ByVal product_id As Integer, ByVal rank As Integer, ByVal wishlist_type As String, ByVal products_series_id As Integer, ByVal products_series_number As Integer, ByVal wl_id As Integer, ByVal imdb_id As Integer) As wishlistRow
