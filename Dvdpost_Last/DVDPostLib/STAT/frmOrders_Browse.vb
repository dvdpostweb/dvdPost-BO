...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        'Products
        _SQLTxt = " SELECT distinct  p.*, op.orders_products_id, op.orders_id, op.products_model AS op_products_model, op.products_name, op.products_price AS op_products_price,  " & _
                  ...
                  "    studio.studio_name, c.customers_language as customers_lang_id,pa.qty_credit,pa.qty_at_home,if(ch.quantity_paid < 0,1,0) paidCust,o.orders_type,o.user_modified " & _
            " FROM         orders o " & _
            ...
            " WHERE date(o.date_purchased) >= '" & DVDPostTools.ClsDate.formatDate(txtDateFrom.DateTime) & "'" & _
            " AND date(o.date_purchased) <= '" & DVDPostTools.ClsDate.formatDate(txtDateTo.DateTime) & "'" & _
            " AND  products_type <> 'ABO'"
