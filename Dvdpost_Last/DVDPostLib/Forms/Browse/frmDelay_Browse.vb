...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDelay_Browse))
...
#End Region
    ...
    Private Sub This_frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CanNew = False
        CanEdit = False
        MyBase.TableName = "custserv_view1"
        MyBase.IDField = "custserv_id"
        MyBase.NameField = "custserv_id"
    ...
    Public Overrides Sub LoadDataSet()
        ...
        'Products
        _SQLTxt = " SELECT * FROM custserv cs " & _
            " left join customers c on c.customers_id = cs.customers_id " & _
            " left join custserv_delayed_detailled csd on cs.custserv_id = csd.custserv_id " & _
            " left join post_redbox pred on pred.post_redbox_id = csd.post_redbox_id " & _
            " left join address_book addr on addr.customers_id = cs.customers_id and addr.address_book_id = c.customers_default_address_id" & _
            " where custserv_cat_id in (3, 5) " & _
            " AND customer_date >= '" & txtDateFrom.DateTime.Year & "-" & txtDateFrom.DateTime.Month & "-" & txtDateFrom.DateTime.Day & " 00:00:00' " & _
            " AND customer_date <= '" & txtDateTo.DateTime.Year & "-" & txtDateTo.DateTime.Month & "-" & txtDateTo.DateTime.Day & " 23:59:59' " & _
            " "
        ...
        UcPivotGrid1.PivotGrid1.DataSource = objDS.Tables(TableName).DefaultView '_View 
