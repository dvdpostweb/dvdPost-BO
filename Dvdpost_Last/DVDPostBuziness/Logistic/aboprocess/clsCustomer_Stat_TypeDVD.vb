Public Class clsCustomer_Stat_TypeDVD
    ...
    Public Sub New(ByVal customers_id As Integer, ByVal var_typeDvd As DvdPostData.clsProductDvd.Type_DVD, ByVal sleep As Boolean)
        ...
        stop_process = False
        dt_wishlist = Nothing
        statSend = New clsCustomer_Stat_TypeDvd_STAT(customers_id, sleep)
        maxDvdSend = 0
        typeDvd = var_typeDvd
    End Sub
End Class
