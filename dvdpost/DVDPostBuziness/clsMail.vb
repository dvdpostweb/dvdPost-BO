...
Public Class clsMail
    ...
    Public Enum Mail
        ...
        MAIL_PAYMENT_INVALID_OGONE = 438
    ...
    End Function
    Private Shared Function ReplaceVar(ByVal msg As String, ByVal key As String, ByVal val As String, ByRef lstvariable As String) As String
    ...
    Private Shared Sub replaceParamCommun(ByVal CustRow As DataRow, _
        ...
        strmessage = ReplaceVar(strmessage, balise & "mail_messages_sent_history_id" & balise, mailHistoryId + 1, lstvariable)
        ''customers_id
