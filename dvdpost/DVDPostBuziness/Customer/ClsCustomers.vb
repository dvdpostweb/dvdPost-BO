...
#Region "Reconduction"
    ...
    Private Sub UpdateCredit(ByVal drCustomer As DataRow, ByVal price As String, Optional ByVal Forcedcredit As Integer = 0)
        ...
        End If
        InsertCreditHistory(GetCustomersId(drCustomer), creditAction, credit)
    ...
    Private Sub InsertCreditHistory(ByVal customersId As Integer, ByVal creditAction As DvdPostData.clsCreditHistory.ActionId, ByVal qtyCredit As Integer)
        Dim sql As String
        sql = DvdPostData.clsCreditHistory.GetInsertCreditHistory(qtyCredit, customersId, creditAction)
        DvdPostData.clsConnection.ExecuteNonQuery(sql)
    End Sub
...
#End Region
    ...
    Public Function RejetFileOgone() As Boolean
        ...
        batch = clsBatchOgone.CreateBatchFile(dt, DvdPostData.ClsCustomersData.Country.BELGIQUE)
    ...
    Public Function ActivationDom70Domiciliation() As Boolean
        ...
        Try
            dtResult_dom70 = Activation(ClsCustomersData.Payment_Method.DOMICILIATION, ClsCustomersData.Country.BELGIQUE)
                ...
                If dtResult_dom70.Rows.Count > 0 Then
                    ...
                    For Each dtCurrent As DataTable In lst_Clientbank
                        ...
                        DVDPostTools.clsFile.WriteFile(clsDom70_128.CreatePathFile(DVDPostTools.clsEnum.getNameStrEnum(DvdPostData.ClsBatchDomiciliation.TypeBatch.ACTIVATION_DOM70), _
                                                                                   DVDPostTools.clsEnum.getNameStrEnum(ClsCustomersData.Country.BELGIQUE), bic), flux_dom70)
        ...
        Try
            ...
            If dtResult_dom80.Rows.Count > 0 Then
                ...
                DVDPostTools.clsFile.WriteFileNoExist(clsBatchdomiciliation.CreatePathFile(DVDPostTools.clsEnum.getNameStrEnum(DvdPostData.ClsBatchDomiciliation.TypeBatch.RECONDUCTION_DOM80), _
                                                                              DVDPostTools.clsEnum.getNameStrEnum(ClsCustomersData.Country.BELGIQUE)), flux_dom80)
    ...
    Public Function ReconductionForced(ByVal customers_id As Integer) As Boolean
        ...
        Select Case payment_method
            Case DvdPostData.ClsCustomersData.Payment_Method.VIREMENT
                Return ReconductionVirement(ClsCustomersData.Country.BELGIQUE, customers_id)
                'Case DvdPostData.ClsCustomersData.Payment_Method.VIREMENT
