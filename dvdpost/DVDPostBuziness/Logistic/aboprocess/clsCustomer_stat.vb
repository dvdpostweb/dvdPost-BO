Public Class clsCustomer_stat
    ...
    Public Sub New(ByVal Pcustomers_id As Integer)

        customers_id = Pcustomers_id
        Norm = New clsCustomer_Stat_TypeDVD(Pcustomers_id, DvdPostData.clsProductDvd.Type_DVD.DVD_NORM)
        Adult = New clsCustomer_Stat_TypeDVD(Pcustomers_id, DvdPostData.clsProductDvd.Type_DVD.DVD_ADULT)
    End Sub
