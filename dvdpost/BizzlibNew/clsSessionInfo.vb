...
Namespace BizzLibNew
    Public Class clsSessionInfo
        ' Methods
        Public Sub New(ByVal UserID1 As Integer, ByVal RoleID1 As Integer, Optional ByVal vDBName As String = "", Optional ByVal vDBConnString As String = "", Optional ByVal vDBConType As String = "")
        ...
        Public Function GlobalOrLocalEntityList(ByVal GlobalState As clsGlobal.GlobalState) As String
        ...
        Private Function LoadEntityListData() As String
            ...
            If (Me.RoleID <> 0) Then
                ...
                Try
                    clsDs.FillDataSet(security.Tables.Item("generalentity"), str2)
                Catch exception1 As Exception
                    ProjectData.SetProjectError(exception1)
                    Dim exception As Exception = exception1
                    Throw exception
        ...
        Private Function LoadGlobalParameters() As DataTable
            ...
            Try
                clsDs.FillDataSet(general.Tables.Item("generalglobalparameter"), sQLTxt)
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
                Throw exception
        ...
        Private Function LoadRoleData() As DataRow
            ...
            Try
                clsDs.FillDataSet(security.Tables.Item("securityrole"), sQLTxt)
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
                Throw exception
        ...
        Private Function LoadUserData() As DataRow
            ...
            Try
                clsDs.FillDataSet(security.Tables.Item("securityuser"), sQLTxt)
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
                Throw exception
