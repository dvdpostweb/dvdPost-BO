...
Namespace BizzLibNew
    Public Class clsGlobal
        ' Methods
        Public Sub New(ByVal CurrentSessionInfo As BizzlibNew.ClsSessionInfo)
        ...
        '    Try
        '        [dset].FillDataSet(set2.Tables.Item("RowsCount"), SQLTxt)
        ...
        '    Try
        '        [dset].FillDataSet(set2.Tables.Item("FieldTable"), SQLTxt)
        ...
        '    Try
        '        [dset].FillDataSet(set2.Tables.Item("IDTable"), SQLTxt)
        ...
        '        [dset].FillDataSet(set2.Tables.Item("MenuSub"), sQLTxt)
        '    Catch exception1 As Exception
        '        ProjectData.SetProjectError(exception1)
        '        Dim exception As Exception = exception1
        '        Throw exception
        ...
        '        general.Tables.Item("systemcurrencyexrate").Clear()
        '        [dset].FillDataSet(general.Tables.Item("systemcurrencyexrate"), str2)
        '        If (general.Tables.Item("systemcurrencyexrate").Rows.Count > 0) Then
        '            If Operators.ConditionalCompareObjectEqual(general.Tables.Item("systemcurrencyexrate").Rows.Item(0).Item("ExRate"), 0, False) Then
        '                num = 1
        '            Else
        ...
        '    Try
        '        [dset].FillDataSet(set2.Tables.Item("FieldLabel"), sQLTxt)
        '    Catch exception1 As Exception
        '        ProjectData.SetProjectError(exception1)
        '        Dim exception As Exception = exception1
        '        Throw exception
        ...
        Public Sub StartForm(ByVal FormName As String, ByVal AssemblyName As String, ByVal MenuID As Integer, ByVal OwnerForm As Form, Optional ByVal ShowForm As Boolean = True)
            ...
            If FormName = "FrmFlowPaymentOffline" Then

                form = New frmflo


            ElseIf (FormName = "frmGeneral_Browse") Then
                form = New frmGeneral_Browse(Me.SessionInfo)
                If (Me.SetGeneralBrowseParam(DirectCast(form, frmGeneral_Browse), MenuID) = 0) Then
                    Return
                End If
        ...
        Private mvarSessionInfo As BizzlibNew.ClsSessionInfo
