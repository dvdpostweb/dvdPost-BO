...
Namespace BizzLib
    Public Class clsData_Employee
        ...
        Public Sub New(ByVal SessionInfo As clsSessionInfo, ByVal DataSet1 As DataSet, ByVal EmployeeID As Integer, ByVal DataSetType As String, ByVal TableName As String)
            MyBase.New(SessionInfo)
            Me.mvarAddrTableName = "GeneralAddress"
            Dim whereClause As String = (" where EmployeeID = " & Conversions.ToString(EmployeeID) & " ")
            MyBase.Initialize(DataSet1, DataSetType, TableName, "EmployeeID", "SELECT * FROM CRMEmployee", whereClause, "")
        End Sub
        ...
        Public Sub New(ByVal SessionInfo As clsSessionInfo, ByVal DataSet1 As DataSet, ByVal DataSetType As String, ByVal TableName As String, ByVal WhereClause As String, ByVal OrderByTxt As String)
            MyBase.New(SessionInfo, DataSet1, DataSetType, TableName, "EmployeeID", "SELECT * FROM CRMEmployee", WhereClause, OrderByTxt)
            Me.mvarAddrTableName = "GeneralAddress"
        End Sub
        ...
        Public Sub LoadAddress(ByVal DataSet1 As DataSet, ByVal DataSetType As String, ByVal AddrID As Integer)
            ...
            Me.mvarAddrData.TableOfData.Columns.Item("PersonYN").DefaultValue = 1
        ...
        Public Overrides Function ValidateRecordFields(ByRef Row1 As DataRowView) As Integer
            If Operators.ConditionalCompareObjectEqual(Operators.ConcatenateObject(Row1.Item("EmployeeID"), ""), "", False) Then
                Row1.Item("EmployeeID") = MyBase.BKGlobal.GetNextID("EmployeeID")
            End If
            Return -1
        End Function
