Public Class clsThemeTop
    ...
    Public Shared Function GetSearch(ByVal id As Object, ByVal title As Object, ByVal kind As Object, ByVal theme_event As Object) As String
        Dim sql As String
        Dim strId As String = ""
        ...
        sql = "select * from product_lists where 1 " & strId & strTitle & strKind & strTheme_event
        Return sql
