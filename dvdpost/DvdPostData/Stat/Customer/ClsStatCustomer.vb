Public Class ClsStatCustomer
    ...
    Public Shared Function GetListCustomers() As String
        ...
        sql = "select c.customers_id id,(select count(*) size_w from wishlist w where w.customers_id = c.customers_id ) size_w,customers_gender gender,customers_firstname firstname,customers_lastname lastname,customers_email_address email" & _
              ...
              ",ab.entry_street_address street ,ab.entry_postcode postcode,ab.entry_city city,c.customers_newsletter " & _
              " from customers c" & _
              " join address_book ab on ab.customers_id = c.customers_id and ab.address_book_id = c.customers_default_address_id "
