    ...
    Function Main(ByVal cmdArgs() As String) As Integer
        ...
        Try
            If env <> String.Empty Then
                ...
                clscust.ReconductionOgone(DvdPostData.ClsCustomersData.Country.BELGIQUE)
                clscust.ReconductionOgone(DvdPostData.ClsCustomersData.Country.PAYSBAS)
                ...
                clscust.ReconductionDomiciliation(DvdPostData.ClsCustomersData.Country.BELGIQUE)
