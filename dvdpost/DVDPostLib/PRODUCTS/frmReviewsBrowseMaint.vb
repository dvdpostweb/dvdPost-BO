Public Class frmReviewsBrowseMaint
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReviewsBrowseMaint))
        ...
        '
        'frmReviewsBrowseMaint
        '
        resources.ApplyResources(Me, "$this")
        Me.Name = "frmReviewsBrowseMaint"
...
#End Region
    ...
    Public Sub this_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            For Each col As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn In GridView1.Columns
                col.OptionsColumn.ReadOnly = True
            Next

            GridView1.OptionsView.NewItemRowPosition = DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Bottom
            GridView1.ActiveFilter.Add(GridView1.Columns("last_modified"), _
        New DevExpress.XtraGrid.Columns.ColumnFilterInfo("last_modified is null"))
    ...
    Public Overrides Sub gridview1_doubleclick(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles GridView1.DoubleClick
        ...
        _Review_ID = GridView1.GetDataRow(_i)("reviews_id")
        ...
        _frm.ShowDialog(Me)
        If _frm.Need_A_Reload = True Then
            LoadDataSet()
        End If
    End Sub
End Class
