...
Public Class frmDiscountCode
    ...
    Public Sub LoadBKComboMaint()
        Try
            ...
            cmbAboType.Properties.DataSource = GetListCmb(DvdPostData.clsActivationCode.GetProducts(DvdPostData.clsActivationCode.productsTypeAbo), "products_title", "products_id")
    ...
    Private Sub EnablingEditFields(ByVal Enabling As Boolean)
        ...
        cmbAboType.Enabled = Enabling
        cmbNextAboType.Enabled = Enabling
    ...
    Private Sub btnUndoDiscount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
    ...
    Private Sub btnNewDiscountCode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNewDiscountCode.Click
        TabControl1.SelectedTab = tabDiscount
        btnNewDiscount_click(Nothing, Nothing)
    End Sub

    Private Sub btnXls_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnXls.Click
        DVDPostBuziness.clsExport.ExportXls(GridViewDiscount)
    End Sub
End Class
