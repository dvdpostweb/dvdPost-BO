...
#End Region
    ...
    Public Sub BarCode_OK()
        ...
        If txtINFO.Text = "" Then
            ...
            Else
                If _OrderRow("orders_status") = DvdPostData.clsOdersStatusHistory.OrderStatus.ORDERS_STATUS_READY_FOR_EXPEDITION Or _
                    (DvdPostData.clsOdersStatusHistory.OrderStatus.ORDERS_STATUS_EXPEDITED And chkForcedStatus.Checked) Then
