...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupControl3.BackgroundImage = CType(resources.GetObject("GroupControl3.BackgroundImage"), System.Drawing.Image)
        ...
        Me.GroupControl2.BackgroundImage = CType(resources.GetObject("GroupControl2.BackgroundImage"), System.Drawing.Image)
...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        'lbl1.Text = "updating : " & BKGlobal.Cls1.ExecuteNonQuery(_SQLTxt)
        ...
        _SQLTxt = "SELECT P.Products_ID product_id, P.products_type products_type, P.products_model , P.imdb_id, P.products_studio, S.studio_name, P.feesharing, " & _
                  ...
                  " count(PDVD.inout) stock_in_qty , PDVD.products_dvd_status, PDVDS.products_dvd_status_name, P.products_series_number, P.products_sale_price " & _
        ...
        BKGlobal.Cls1.FillDataSet(objDS.Tables("PS_Ana"), _SQLTxt)
        MergeProductInfo()
    ...
    Public Sub MergeProductInfo()
        ...
        BKGlobal.Cls1.FillDataSet(_tmpDS.Tables("Tmp1"), _SqlTxt)
        For Each _row In _tmpDS.Tables("Tmp1").Rows
            _ItemRow = objDS.Tables("PS_Ana").Rows.Find(New Object() {_row.Item("ID")})
            If Not IsNothing(_ItemRow) Then
                _ItemRow.Item("stock_qty") = _row.Item("Int_1")
            End If
        Next
        ...
        If chkStock_with_Cover.Checked = True Then
            ...
            For Each _row In _tmpDS.Tables("Tmp1").Rows
                _ItemRow = objDS.Tables("PS_Ana").Rows.Find(New Object() {_row.Item("ID")})
                If Not IsNothing(_ItemRow) Then
                    _ItemRow.Item("stock_cover_qty") = _row.Item("Int_1")
                End If
            Next
        End If
        ...
        If chkUSeStockIN.Checked = True Then
            ...
            For Each _row In _tmpDS.Tables("Tmp1").Rows
                _ItemRow = objDS.Tables("PS_Ana").Rows.Find(New Object() {_row.Item("ID")})
                If Not IsNothing(_ItemRow) Then
                    _ItemRow.Item("stock_in_qty") = _row.Item("Int_1")
                End If
            Next
        End If
        ...
        For Each _row In objDS.Tables("PS_Ana").Rows
            ...
            If chkSubTitles.Checked Then
                _view = New DataView(_tmpDS.Tables("products_undertitles_View1"), "Products_Id = " & _row.Item("Product_ID"), "", DataViewRowState.CurrentRows)
            ...
            If chkLanguages.Checked Then
                _view = New DataView(_tmpDS.Tables("products_languages_View1"), "Products_Id = " & _row.Item("Product_ID"), "", DataViewRowState.CurrentRows)
                For Each _row2 In _view
                    _row.BeginEdit()
    ...
    Public Sub MergeWhishInfo(ByVal vPart As Integer, ByVal vLimit As String, ByVal vMin As Integer, ByVal vMax As Integer)
        ...
        BKGlobal.Cls1.FillDataSet(_tmpDS.Tables("PS_Ana"), _SQLTxt)
        For Each _row In objDS.Tables("PS_Ana").Rows
            ProgressBar1.EditValue += 1
            ProgressBar1.Refresh()
        ...
        For Each _row In objDS.Tables("PS_Ana").Rows
            ...
            If chkUSeStockIN.Checked Then
                If chkStock_with_Cover.Checked Then
                    _StartStockQty = Math.Min(_row.Item("stock_in_qty"), _row.Item("stock_cover_qty"))
                Else
                    _StartStockQty = _row.Item("stock_in_qty")
                End If
            Else
                If chkStock_with_Cover.Checked Then
                    _StartStockQty = _row.Item("stock_cover_qty")
                Else
                    _StartStockQty = _row.Item("stock_qty")
                End If
            End If
            If _row.Item("stock_qty") = 0 Then
                _row.Item("monthes_w1") = 999
            Else
                _row.Item("monthes_w1") = Math.Ceiling(_row.Item("w_q1") / 5 / _row.Item("stock_qty"))
            End If
            _row.Item("w_mini1") = Math.Ceiling(_row.Item("w_q1") / 5 / txtMini1.Text)
            _row.Item("w_mini2") = Math.Ceiling((_row.Item("w_q1") + _row.Item("w_q2")) / 5 / txtMini2.Text)
            _row.Item("w_mini3") = Math.Ceiling((_row.Item("w_q1") + _row.Item("w_q2") + _row.Item("w_q3")) / 5 / txtMini3.Text)
            _row.Item("stock_mini") = 0
            _row.Item("stock_mini") = Math.Max(_row.Item("stock_mini"), _row.Item("w_mini1"))
            _row.Item("stock_mini") = Math.Max(_row.Item("stock_mini"), _row.Item("w_mini2"))
            _row.Item("stock_mini") = Math.Max(_row.Item("stock_mini"), _row.Item("w_mini3"))
            _row.Item("stock_mini") += txtStockTampon.Text
            If _row.Item("stock_mini") < CInt(txtStockMini.Text) Then
                _row.Item("stock_mini") = CInt(txtStockMini.Text)
            End If
            If _row.Item("stock_mini") <= _StartStockQty Then
                _row.Item("to_sale_qty") = _StartStockQty - _row.Item("stock_mini")
                _row.Item("to_purchase_qty") = 0
            Else
                _row.Item("to_sale_qty") = 0
                _row.Item("to_purchase_qty") = _row.Item("stock_mini") - _StartStockQty
            End If
            _row.Item("qty_flow") = _row.Item("stock_mini") - _StartStockQty
            _row.EndEdit()
        Next
        ProgressBar1.EditValue = 0
        lbl1.Text = ""
