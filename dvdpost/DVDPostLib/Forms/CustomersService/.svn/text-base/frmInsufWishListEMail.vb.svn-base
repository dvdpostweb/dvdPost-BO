...
#End Region
    ...
    '      " count(wl.wl_id) as customers_wishlist_count " & _
    '      " FROM customers C " & _
    ...
    '    mvarsmtpserver = BKGlobal.ExecuteFindFieldValue("ParamValue", DvdPostData.clsEmailWishList.getSmtpServer)
    '    mvarsmtpserverlogin = BKGlobal.ExecuteFindFieldValue("ParamValue", DvdPostData.clsEmailWishList.getServerLogin)
    '    mvarsmtpserverpassword = BKGlobal.ExecuteFindFieldValue("ParamValue", DvdPostData.clsEmailWishList.getServerPassWord)
    ...
    '    DvdPostData.clsConnection.FillDataSet(objDS.Tables("languages"), DvdPostData.clsEmailWishList.getLanguages)
    ...
    Private Sub btnStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnStart.Click
        ...
        For Each rowView As DataRowView In ViewCustToSend
            DVDPostBuziness.clsMail.SendMail(rowView.Row, DVDPostBuziness.clsMail.Mail.MAIL_WISHLIST)
        Next
    ...
    Public Sub LoadCustomerList()
        ...
        Catch eFillDataSet As System.Exception
            Throw eFillDataSet
        End Try
        ViewCustToSend = New DataView(objDS.Tables(TableName), "customers_wishlist_count < 20 ", "customers_id", DataViewRowState.CurrentRows)
