Public Class frmSoundtracksBrowseMaint
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmSoundtracksBrowseMaint))
...
#End Region
    ...
    Public Sub this_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            TableName = "products_soundtracks"
            IDField = "soundtracks_id"
            NameField = "soundtracks_description"
            'SQLTxt1 = "SELECT CodeValue, CodeDesc FROM generalglobalcode "
            WhereClause = " "
            OrderByClause = " order by soundtracks_id "
            MaintenanceMenuID = -1
            CanNew = False
            CanEdit = False
            CanSave = True
