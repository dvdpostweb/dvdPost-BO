Public Class frmDirectorsBrowseMaint
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDirectorsBrowseMaint))
        ...
        '
        'frmDirectorsBrowseMaint_Browse
        '
        ...
        Me.Name = "frmDirectorsBrowseMaint_Browse"
...
#End Region
    ...
    Public Sub this_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            TableName = "directors"
            IDField = "directors_id"
            NameField = "directors_name"
            'SQLTxt1 = "SELECT CodeValue, CodeDesc FROM generalglobalcode "
            WhereClause = " "
            OrderByClause = " order by directors_id "
            MaintenanceMenuID = -1
            CanNew = False
            CanEdit = False
            CanSave = True
        ...
        Catch eLoad As System.Exception
            DVDPostBuziness.clsMsgError.InsertLogMsg(DvdPostData.clsMsgError.processType.Email, eLoad)
