...
Partial Public Class dsCustomerMaint
    ...
    Partial Public Class customersDataTable
        ...
        Public Overloads Function AddcustomersRow( _
                    ...
                    ByVal access_token_expires_at As Date) As customersRow
    ...
    Partial Public Class customer_attributesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function Addcustomer_attributesRow(ByVal customer_id As Integer, ByVal list_indicator_close As Boolean, ByVal number_of_logins As Integer, ByVal last_login_at As Date, ByVal created_at As Date, ByVal updated_at As Date) As customer_attributesRow
            Dim rowcustomer_attributesRow As customer_attributesRow = CType(Me.NewRow,customer_attributesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, customer_id, list_indicator_close, number_of_logins, last_login_at, created_at, updated_at}
